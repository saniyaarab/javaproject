...
public class CUtilities
{
	...
	// --------------------------------------------------------------------------------
	// Name: IsValidZipCode
	// Abstract : Validated Zipcode using Regular Expressions
	// --------------------------------------------------------------------------------
	...
	// Abstract: Validated Phone Number using Regular Expressions
	// --------------------------------------------------------------------------------
	public static boolean IsValidPhoneNumber( String strHomePhoneNumber )
	{
		...
		try
		{
			...
			// \ is escape character in regular expression in Java it must be doubled \\
			String strSpaceOrDashOrDot = "[\\-\\.]";
			String strOptionalIsSpaceOrDashOrDot = strSpaceOrDashOrDot + "?";
			
			//###-####
			String strPattern1 = chrStart + "\\d{3}" + strSpaceOrDashOrDot + "\\d{4}" + chrStop;
			
			//###-###-####
			String strPattern2 = chrStart + "\\d{3}" + strSpaceOrDashOrDot + "\\d{3}" + strOptionalIsSpaceOrDashOrDot + "\\d{4}" + chrStop;
			
			//(###)###-####
			String strPattern3 = chrStart + "\\(\\d{3}\\)" + strOptionalIsSpaceOrDashOrDot + "\\d{3}" + strSpaceOrDashOrDot + "\\d{4}" + chrStop;
			
			//Does it match any of the formats
			if( strHomePhoneNumber.matches( strPattern1 ) == true ||
				strHomePhoneNumber.matches( strPattern2 ) == true ||
				strHomePhoneNumber.matches( strPattern3 ) == true )
			{
				//Yes
	...
	// --------------------------------------------------------------------------------
	// Name: IsCurrency
	// Abstract: Validated Salary using Regular Expressions
	// --------------------------------------------------------------------------------
	public static boolean IsCurrency( String strBuffer )
	{
		...
		try
		{
			...
			//Same as above but with commas every3 digits (e.g 12,345).
	...
	// --------------------------------------------------------------------------------
	// Name: IsValidDate
	// Abstract: Use Regular Ecpressions to verify the Date
	// --------------------------------------------------------------------------------
	...
	/*// --------------------------------------------------------------------------------
	// Name: IsValidDate
	// Abstract: Use Regular Expressions to verify the Date
	// --------------------------------------------------------------------------------
	...
	// -------------------------------------------------------------------------
	// Name: IsNumeric
	// Abstract: Verify string if it has valid numeric format
	// -------------------------------------------------------------------------
	public static Boolean IsNumeric( String strBuffer )
	{
		...
		try
		{
			...
			// \ escape character in reg expression an Java so it must be doubled up
